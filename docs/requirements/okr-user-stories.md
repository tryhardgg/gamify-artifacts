# User Stories — Модуль OKR (Epic 0/1)
...
- **Use Cases:** Детальные сценарии с альтернативными потоками, бизнес-правилами и обработкой ошибок — в [`docs/requirements/okr-use-cases.md`](okr-use-cases.md).
- **Use Case Diagram:** Визуальная карта сценариев модуля OKR — в [`docs/requirements/okr-use-case-diagram.mmd`](okr-use-case-diagram.mmd).
- **UI-спецификация:** Описание экранов и компонентов — в [`docs/ui-screens.md`](../ui-screens.md).
- **API-контракты:** Форматы запросов/ответов — в [`docs/api/okr-api.md`](../api/okr-api.md).
